...
enum {
    ...
    /**nanosic add by paulo*/
    AUDIO_DEVICE_IN_VAUDIO_DEVICE         = AUDIO_DEVICE_BIT_IN | 0x2000,
    /**nanosic end */
    AUDIO_DEVICE_IN_USB_MIC               = AUDIO_DEVICE_BIT_IN | 0x1000000,
    ...
    AUDIO_DEVICE_IN_ALL     = (AUDIO_DEVICE_IN_COMMUNICATION |
                               ...
                               /**nanosic add by paulo*/
                               AUDIO_DEVICE_IN_VAUDIO_DEVICE |
                               /**nanosic end */
                               AUDIO_DEVICE_IN_USB_MIC |
